...
Route::middleware('auth')->group(function () {
    ...
    Route::get('employee/index', [App\Http\Controllers\employeecontroller::class, 'index'])->name('employee.show');
    Route::get('users', [\App\Http\Controllers\UserController::class, 'index'])->name('users.index');
    Route::get('employee', [\App\Http\Controllers\employeecontroller::class, 'index'])->name('employee.index');
    Route::get('employee/create', [App\Http\Controllers\employeecontroller::class, 'create'])->name('employe.create');
    ...
    Route::get('employee/{id}/delete', [App\Http\Controllers\employeecontroller::class, 'Destroy'])->name('employee.Destroy');
