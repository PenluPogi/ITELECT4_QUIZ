...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
        <a href="{{ route('employe.create') }}" class="btn btn-info">Add New Employee</a>
        <div class="row">
                    ...
                    <table class="table table-bordered table-stiped fs-1 text-black">
                        ...
                        <tbody  >
                            ...
                            <tr>
                                ...
                                <span class="badge bg-danger"><a href="{{  route('employee.Destroy',$items->id)}}" class="m-3 p-lg-5"><h5>Delete</h5></a></span>
                                </td>
